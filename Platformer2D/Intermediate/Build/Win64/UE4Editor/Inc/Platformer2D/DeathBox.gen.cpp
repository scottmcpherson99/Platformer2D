...
#include "Platformer2D/DeathBox.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	PLATFORMER2D_API UClass* Z_Construct_UClass_ADeathBox_NoRegister();
	PLATFORMER2D_API UClass* Z_Construct_UClass_ADeathBox();
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ADeathBox_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ADeathBox_OnTriggerBoxOverlap, "OnTriggerBoxOverlap" }, // 4075882720
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ADeathBox_Statics::NewProp_TriggerBox = { "TriggerBox", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ADeathBox, TriggerBox), Z_Construct_UClass_UBoxComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ADeathBox_Statics::NewProp_TriggerBox_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ADeathBox_Statics::NewProp_TriggerBox_MetaData)) };
	...
	IMPLEMENT_CLASS(ADeathBox, 107529986);
	template<> PLATFORMER2D_API UClass* StaticClass<ADeathBox>()
	{
		return ADeathBox::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ADeathBox(Z_Construct_UClass_ADeathBox, &ADeathBox::StaticClass, TEXT("/Script/Platformer2D"), TEXT("ADeathBox"), false, nullptr, nullptr, nullptr);
